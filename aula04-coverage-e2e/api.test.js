...
describe('API Suite Test', () => {
    ...
    describe('/login', () => {
        ...
        it('should unauthorize a request when requesting it using wrong credentials and return HTTP Status code 401', async () => {
            const response = await request(app)
                                .post('/login')
                                .send({ username: 'matheusFail', password: '123456'})
                                .expect(401)
