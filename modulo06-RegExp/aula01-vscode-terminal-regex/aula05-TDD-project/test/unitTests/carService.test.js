...
describe('CarService Suite Tests', () => {
    ...
    it('should retrieve a rondom position from an array', () => {
    ...
    it('given a carCategory it should return an available car', async () => {
        ...
        //Object.create() = cópia sem sujar instancia original
    ...
    it('given a cusromer and a car category it should return a transaction receipt',  async () => {
        const car = mocks.validCar
        //cópia sem sujar instancia original
        const carCategory = {
